...
Mu45PtCut = OP_LowerMuPtCut(50.0)
...
def MakeDataTree(Threshold,Muon = None,Split = None):
  ...
  if Muon == None:
      ...
      print "hhehehhehehehhehehh"
      print genericPSet_data.isData

  else:
      if Split == "Muon_All" and int(Threshold) is 100:
        print "cut on muon pT MC"
      ...
      htBins = HTBins,TriggerDict = (mu_triggers if Split == "Muon_All" and int(Threshold) is 100 else triggers),lab = "OneMuon_") )
...
def MakeMCTree(Threshold, Muon = None,Split = None):
  ...
  if Muon == None:
      ...
      out.append(AddBinedHist(cutTree = cutTreeMC,
      OP = ("WeeklyUpdatePlots",genericPSet_mc), cut = PFMTCut30,
...
Data_Sample_2011AB = [ HT_Run2011AB ]
Data_Sample_2011A = [ HT_Run2011A ]
Data_Sample_2011B = [ HT_Run2011A ]
