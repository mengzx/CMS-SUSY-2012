...
zerobtagOneMuon= OP_NumCommonBtagJets("==",0,0.679)
more_than_zero_btagOneMuon= OP_NumCommonBtagJets(">",0,0.679)
onebtagOneMuon= OP_NumCommonBtagJets("==",1,0.679)
more_than_one_btagOneMuon= OP_NumCommonBtagJets(">",1,0.679)
twobtagOneMuon= OP_NumCommonBtagJets("==",2,0.679)
more_than_two_btagOneMuon= OP_NumCommonBtagJets(">",2,0.679)

zerobtag= OP_NumCommonBtagJets("==",0,0.679)
more_than_zero_btag= OP_NumCommonBtagJets(">",0,0.679)
onebtag= OP_NumCommonBtagJets("==",1,0.679)
more_than_one_btag= OP_NumCommonBtagJets(">",1,0.679)
twobtag= OP_NumCommonBtagJets("==",2,0.679)
more_than_two_btag= OP_NumCommonBtagJets(">",2,0.679)
...
def MakeDataTree(Threshold,Muon = None,Split = None):
  ...
  if Muon == None:
      ...
      htBins = HTBins,TriggerDict = (mu_triggers if Split =="One" or Split=="Two" else triggers) ,lab ="btag_zero_OneMuon_") )

      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_zero_btagOneMuon,
      htBins = HTBins,TriggerDict = (mu_triggers if Split =="One" or Split=="Two" else triggers) ,lab ="btag_morethanzero_OneMuon_") )

      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = onebtagOneMuon,
      htBins = HTBins,TriggerDict = (mu_triggers if Split =="One" or Split=="Two" else triggers) ,lab ="btag_one_OneMuon_") )

      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_one_btagOneMuon,
      htBins = HTBins,TriggerDict = (mu_triggers if Split =="One" or Split=="Two" else triggers) ,lab ="btag_morethanone_OneMuon_") )

      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = twobtagOneMuon,
      htBins = HTBins,TriggerDict = (mu_triggers if Split =="One" or Split=="Two" else triggers) ,lab ="btag_two_OneMuon_") )

      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_two_btagOneMuon,
      htBins = HTBins,TriggerDict = (mu_triggers if Split =="One" or Split=="Two" else triggers) ,lab ="btag_morethantwo_OneMuon_") )


      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = PFMTCut30,
      htBins = HTBins,TriggerDict = (mu_triggers if Split =="One" or Split=="Two" else triggers),lab = "OneMuon_") )
      ...
      htBins = HTBins,TriggerDict = (mu_triggers if Split =="One" or Split=="Two" else triggers),lab ="btag_zero_DiMuon_") )

      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_zero_btagDiMuon,
      htBins = HTBins,TriggerDict = (mu_triggers if Split =="One" or Split=="Two" else triggers),lab ="btag_morethanzero_DiMuon_") )

      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = onebtagDiMuon,
      htBins = HTBins,TriggerDict =(mu_triggers if Split =="One" or Split=="Two" else triggers),lab ="btag_one_DiMuon_") )
   
      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_one_btagDiMuon,
      htBins = HTBins,TriggerDict =(mu_triggers if Split =="One" or Split=="Two" else triggers),lab ="btag_morethanone_DiMuon_") )
   
      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = twobtagDiMuon,
      htBins = HTBins,TriggerDict =(mu_triggers if Split =="One" or Split=="Two" else triggers),lab ="btag_two_DiMuon_") )
   
      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_two_btagDiMuon,
      htBins = HTBins,TriggerDict =(mu_triggers if Split =="One" or Split=="Two" else triggers),lab ="btag_morethantwo_DiMuon_") )
    
      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = ZMass_2Muons,
      htBins = HTBins,TriggerDict = (mu_triggers if Split =="One" or Split=="Two" else triggers),lab = "DiMuon_") )
...
DiBoson_Samples = [ WW_TuneZ2_7TeV_pythia6_tauola_Fall11_PU_S6_START42_V14B_v1, 
