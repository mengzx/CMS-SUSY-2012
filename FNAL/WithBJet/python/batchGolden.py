...
triggers = {
    "275":["HLT_HT250_AlphaT0p55_v*","HLT_HT250_AlphaT0p57_v*"],
    "275_325":["HLT_HT250_AlphaT0p55_v*","HLT_HT250_AlphaT0p57_v*"],
    "325_375":["HLT_HT250_AlphaT0p55_v*","HLT_HT250_AlphaT0p57_v*","HLT_HT300_AlphaT0p53_v*"],
    "375_475":["HLT_HT250_AlphaT0p55_v*","HLT_HT250_AlphaT0p57_v*","HLT_HT300_AlphaT0p53_v*","HLT_HT350_AlphaT0p52_v*","HLT_HT350_AlphaT0p53_v*"],
    "475_575":["HLT_HT250_AlphaT0p55_v*","HLT_HT250_AlphaT0p57_v*","HLT_HT300_AlphaT0p53_v*","HLT_HT350_AlphaT0p52_v*","HLT_HT350_AlphaT0p53_v*","HLT_HT400_AlphaT0p52_v*","HLT_HT450_AlphaT0p51_v*"],
    "575_675":["HLT_HT250_AlphaT0p55_v*","HLT_HT250_AlphaT0p57_v*","HLT_HT300_AlphaT0p53_v*","HLT_HT350_AlphaT0p52_v*","HLT_HT350_AlphaT0p53_v*","HLT_HT400_AlphaT0p52_v*","HLT_HT450_AlphaT0p51_v*"],
    "675_775":["HLT_HT250_AlphaT0p55_v*","HLT_HT250_AlphaT0p57_v*","HLT_HT300_AlphaT0p53_v*","HLT_HT350_AlphaT0p52_v*","HLT_HT350_AlphaT0p53_v*","HLT_HT400_AlphaT0p52_v*","HLT_HT450_AlphaT0p51_v*"],
    "775_875":["HLT_HT250_AlphaT0p55_v*","HLT_HT250_AlphaT0p57_v*","HLT_HT300_AlphaT0p53_v*","HLT_HT350_AlphaT0p52_v*","HLT_HT350_AlphaT0p53_v*","HLT_HT400_AlphaT0p52_v*","HLT_HT450_AlphaT0p51_v*"],
    "875":
    ["HLT_HT250_AlphaT0p55_v*","HLT_HT250_AlphaT0p57_v*","HLT_HT300_AlphaT0p53_v*","HLT_HT350_AlphaT0p52_v*","HLT_HT350_AlphaT0p53_v*","HLT_HT400_AlphaT0p52_v*","HLT_HT450_AlphaT0p51_v*"],
}

single_mu_triggers = {
    "275_325":["HLT_IsoMu24_eta2p1_v*","HLT_IsoMu30_eta2p1_v*","HLT_IsoMu34_eta2p1_v*","HLT_IsoMu40_eta2p1_v*"],
    "325_375":["HLT_IsoMu24_eta2p1_v*","HLT_IsoMu30_eta2p1_v*","HLT_IsoMu34_eta2p1_v*","HLT_IsoMu40_eta2p1_v*"],
    "375_475":["HLT_IsoMu24_eta2p1_v*","HLT_IsoMu30_eta2p1_v*","HLT_IsoMu34_eta2p1_v*","HLT_IsoMu40_eta2p1_v*"],
    "475_575":["HLT_IsoMu24_eta2p1_v*","HLT_IsoMu30_eta2p1_v*","HLT_IsoMu34_eta2p1_v*","HLT_IsoMu40_eta2p1_v*"],
    "575_675":["HLT_IsoMu24_eta2p1_v*","HLT_IsoMu30_eta2p1_v*","HLT_IsoMu34_eta2p1_v*","HLT_IsoMu40_eta2p1_v*"],
    "675_775":["HLT_IsoMu24_eta2p1_v*","HLT_IsoMu30_eta2p1_v*","HLT_IsoMu34_eta2p1_v*","HLT_IsoMu40_eta2p1_v*"],
    "775_875":["HLT_IsoMu24_eta2p1_v*","HLT_IsoMu30_eta2p1_v*","HLT_IsoMu34_eta2p1_v*","HLT_IsoMu40_eta2p1_v*"],
    "875":["HLT_IsoMu24_eta2p1_v*","HLT_IsoMu30_eta2p1_v*","HLT_IsoMu34_eta2p1_v*","HLT_IsoMu40_eta2p1_v*"],
}
...
def MakeDataTree(Threshold,Muon = None,Split = None):
  ...
  if Muon == None:
	  ...
	  out.append(AddBinedHist(cutTree = cutTreeData,
          ...
          out.append(AddBinedHist(cutTree = cutTreeData,
          OP = ("TauFakeB",genericPSet_data), cut = ZMass_2Muons,
          htBins = HTBins,TriggerDict = (mu_triggers if ( ( Split == "Muon_All" and int(Threshold) is 100 ) ) else triggers), lab = "DiMuon_", split = genericPSet_data.mode ) )
...
def MakeMCTree(Threshold, Muon = None,Split = None):
  ...
  if Muon == None:
      ...
      print "test"
      print "mode1="+genericPSet_mc.mode
  else:
      print "test1"
      if Split == "Muon_All" and int(Threshold) is 100:
          cutTreeMC.TAttach(VertexPtOverHT,htCut275)
      ...
      htBins = HTBins,TriggerDict = None, lab = "DiMuon_", split = genericPSet_mc.mode) )
