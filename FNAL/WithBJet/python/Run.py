...
def getnewFile( sDataSet, sMuonForm, sSplitForm, sTreeThr, ssample, FileName, sSite, sIllustration ):
    ...
    for line in open( "MuonNoSmearinvar.py" ):
        ...
        line = line.replace( "SILLUSTRATION", sIllustration )
        output.write(line+"\n")
    output.close()
...
list_TreeThr=[ "100" ]
#list_sample_mc = ["Zinv", "WJ", "TT", "SingleT","DiBoson", "DY", "ALL", "TanB10_320_520", "TanB10_1800_280", "T2", "T2tt", "ALL_NoZinv", "QCD"]
list_sample_mc = [ "WJ", "TT", "DY" ]
#list_sample_data = [ "DataHT", "DataHT2011A", "DataHT2011B", "DataSingleMu", "DataSingleMu2011A", "DataSingleMu2011B", "DataSingleMu2012A", "DataHT2012A", "DataDoubleMu2012A", "DataMuHad2012A", "DataPhoton2012A"]
list_sample_data = ["DataSingleMu2012A", "DataHT2012A", "DataMuHad2012A" ]
list_sample=[]
list_site = ["FNAL"]
            ...
            for itreethr in range( len( list_TreeThr ) ):
                ...
                for isample in range( len( list_sample ) ):
                    ...
                    for isite in range ( len( list_site ) ):
                        ...
                        (output,newFile) = getnewFile( list_DataSet[idataset], list_Muon[imuon], list_SplitForm[isplit], list_TreeThr[itreethr], list_sample[isample] , FileName, sSite, sIllustration )
                        print "site="+sSite
                        print "in Run.py"
                        ...
                        subprocess.call( ["./%s" % (newFile), "-b", "-n100" ] )
