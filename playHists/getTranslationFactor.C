...
vector<TH2D*> getTranslationFactor::TranslationFactor_1To2Mu( bool MuAddOrNot, bool fullesti, TString HTBins, bool isData){
  ...
  vector<TString> hName1mu;
  if( normalEstimation_ == true ){
    hName1mu=vhname_pusback_domin(false, true, startNJet_, nJets_);
    if( isData == true ){
      hNamehad=vhname_pusback_data(false, true, startNJet_, nJets_);
    } else{
      hNamehad=vhname_pusback_numer(false, true, startNJet_, nJets_);
    }
  }
...
// -----------------------------------------------------------------------------
//
TH2D* getTranslationFactor::getFactor( bool MuAddOrNot, bool fullesti, TString HTBins, bool isData, TString closureTests, int iJetStart, int iJet_n, int jJetStart, int jJet_n ){
  if( closureTests == "1To2Mu" ){
    vector<TH2D*> factorHist_hasTauHadToMuAdded=TranslationFactor_1To2Mu( MuAddOrNot, fullesti, HTBins, isData );
    return factorHist_hasTauHadToMuAdded[2];
  } else if ( closureTests == "iTojJet"){
    vector<TH2D*> factorHist_hasTauHadToMuAdded=TranslationFactor_iTojJet( MuAddOrNot, fullesti, HTBins, isData, iJetStart, iJet_n, jJetStart, jJet_n );
    return factorHist_hasTauHadToMuAdded[2];
  }else {
...
// -----------------------------------------------------------------------------
//
TH2D* getTranslationFactor::getNumerMC( bool MuAddOrNot, bool fullesti, TString HTBins, TString closureTests, int iJetStart, int iJet_n, int jJetStart, int jJet_n ){
  if( closureTests == "1To2Mu" ){
    vector<TH2D*> factorHist_hasTauHadToMuAdded=TranslationFactor_1To2Mu( MuAddOrNot, fullesti, HTBins, false );
    return factorHist_hasTauHadToMuAdded[0];
  } else if ( closureTests == "iTojJet"){
    vector<TH2D*> factorHist_hasTauHadToMuAdded=TranslationFactor_iTojJet( MuAddOrNot, fullesti, HTBins, false, iJetStart, iJet_n, jJetStart, jJet_n );
    return factorHist_hasTauHadToMuAdded[0];
  } else {
...
// -----------------------------------------------------------------------------
//
TH2D* getTranslationFactor::getDominMC( bool MuAddOrNot, bool fullesti, TString HTBins, TString closureTests, int iJetStart, int iJet_n, int jJetStart, int jJet_n ){
  if( closureTests == "1To2Mu" ){
    vector<TH2D*> factorHist_hasTauHadToMuAdded=TranslationFactor_1To2Mu( MuAddOrNot, fullesti, HTBins, false );
...
TH2D* getTranslationFactor::getControlData( bool MuAddOrNot, bool fullesti, TString HTBins, TString closureTests, int iJetStart, int iJet_n, int jJetStart, int jJet_n ){
  if( closureTests == "1To2Mu" ){
    ...
    vector<TH2D*> Data1mu=TranslationFactor_iTojJet( MuAddOrNot, fullesti, HTBins, true, iJetStart, iJet_n, jJetStart, jJet_n );
    return Data1mu[1];
  } else {
...
TH2D* getTranslationFactor::getYieldData( bool MuAddOrNot, bool fullesti, TString HTBins, TString closureTests, int iJetStart, int iJet_n, int jJetStart, int jJet_n ){
  if( closureTests == "1To2Mu" ){
    vector<TH2D*> Data1mu=TranslationFactor_1To2Mu( MuAddOrNot, fullesti, HTBins, true );
    return Data1mu[0];
  } else if ( closureTests == "iTojJet"){
...
TH2D* getTranslationFactor::getPredBG( bool MuAddOrNot, bool fullesti, TString HTBins, TString closureTests, int iJetStart, int iJet_n, int jJetStart, int jJet_n ){
  TH2D* factorh=getFactor( MuAddOrNot, fullesti, HTBins, false, closureTests, iJetStart, iJet_n, jJetStart, jJet_n );
  TH2D* Data1mu=getControlData( MuAddOrNot, fullesti, HTBins, closureTests, iJetStart, iJet_n, jJetStart, jJet_n );
...
// -----------------------------------------------------------------------------
//
void getTranslationFactor::baseCheck( bool MuAddOrNot, bool fullesti, TString HTBins, TString plotname, bool isData, TString closureTests, int iJetStart, int iJet_n, int jJetStart, int jJet_n ){
  playHist2D factor=playHist2D();
  ...
  if( closureTests == "1To2Mu"){
    factorHist=TranslationFactor_1To2Mu( MuAddOrNot, fullesti, HTBins, isData );
  } else if ( closureTests == "iTojJet" ){
    factorHist=TranslationFactor_iTojJet( MuAddOrNot, fullesti, HTBins, isData, iJetStart, iJet_n, jJetStart, jJet_n );
  } else {
    factorHist=TranslationFactor( MuAddOrNot, fullesti, HTBins, isData );
  }
  ...
  if( closureTests == "1To2Mu"){
    ...
    c1->SaveAs( Form( "numer"+plotname+"_"+closureTests+"_%d_%dTo%d_%d.eps", iJetStart-1, iJetStart+iJet_n-2, jJetStart-1, jJetStart+jJet_n-2 ) );
  } else {
    c1->SaveAs("numer"+plotname+"_"+closureTests+".eps");
  }
  c1->Update();
  ...
  if( closureTests == "1To2Mu"){
    ...
    c1->SaveAs( Form( "domin"+plotname+"_"+closureTests+"_%d_%dTo%d_%d.eps", iJetStart-1, iJetStart+iJet_n-2, jJetStart-1, jJetStart+jJet_n-2 ) );
  } else {
    c1->SaveAs("domin"+plotname+"_"+closureTests+".eps");
  }
  c1->Update();
...
void getTranslationFactor::getResults( TString closureTests, int iJetStart, int iJet_n, int jJetStart, int jJet_n ){
  playHist2D factor=playHist2D();

  if(normalEstimation_ == true ){
    baseCheck( false, true, "all", "", false, closureTests, iJetStart, iJet_n, jJetStart, jJet_n );
    baseCheck( false, true, "all", "_Data", true, closureTests, iJetStart, iJet_n, jJetStart, jJet_n );
  } else {
    baseCheck( true, false, "all", "tauHadEsti_AddMuToAT", false, closureTests, iJetStart, iJet_n, jJetStart, jJet_n );
    baseCheck( true, false, "all", "tauHadEsti_AddMuToAT", false, closureTests, iJetStart, iJet_n, jJetStart, jJet_n );
    baseCheck( false, false, "all", "LepEsti_NotAddMuToAT", false, closureTests, iJetStart, iJet_n, jJetStart, jJet_n );
    baseCheck( false, false, "all", "LepEsti_NotAddMuToAT_Data", true, closureTests, iJetStart, iJet_n, jJetStart, jJet_n );
  }
  ...
  TH2D* pred_Lep;
  if(normalEstimation_ == true ){
    pred_AddMu=getPredBG( true, false, "all", closureTests, iJetStart, iJet_n, jJetStart, jJet_n  );
  } else{
    pred_AddMu=getPredBG( true, false, "all", closureTests, iJetStart, iJet_n, jJetStart, jJet_n  );
    pred_NotTauHad=getPredBG( false, true, "all", closureTests, iJetStart, iJet_n, jJetStart, jJet_n  );
    pred_Lep=getPredBG( false, false, "all", closureTests, iJetStart, iJet_n, jJetStart, jJet_n  );
  }
  ...
  if( normalEstimation_ == true ){
    if( closureTests == "1To2Mu"){
      ...
      c1->SaveAs( Form( "pred_"+closureTests+"_%d_%dTo%d_%d.eps", iJetStart-1, iJetStart+iJet_n-2, jJetStart-1, jJetStart+jJet_n-2 ) );
    } else {
      c1->SaveAs("pred_"+closureTests+".eps");
    }
  } else {
    if( closureTests == "1To2Mu"){
      ...
      c1->SaveAs( Form( "pred_TauHad_"+closureTests+"_%d_%dTo%d_%d.eps", iJetStart-1, iJetStart+iJet_n-2, jJetStart-1, jJetStart+jJet_n-2 ) );
    } else {
      c1->SaveAs("pred_TauHad_"+closureTests+".eps");
    }
  }
  ...
  if(normalEstimation_ == false ){
    ...
    if( closureTests == "1To2Mu"){
      ...
      c1->SaveAs(Form( "pred_Lep_"+closureTests+"_%d_%dTo%d_%d.eps", iJetStart-1, iJetStart+iJet_n-2, jJetStart-1, jJetStart+jJet_n-2 ) );
    } else {
      c1->SaveAs("pred_Lep_"+closureTests+".eps");
    }
    c1->Update();
    ...
    if( closureTests == "1To2Mu"){
      ...
      c1->SaveAs(Form( "pred_NotTauHad_"+closureTests+"_%d_%dTo%d_%d.eps", iJetStart-1, iJetStart+iJet_n-2, jJetStart-1, jJetStart+jJet_n-2 ) );
    } else {
      c1->SaveAs("pred_NotTauHad_"+closureTests+".eps");
    }
    c1->Update();
    ...
    if( closureTests == "1To2Mu"){
      ...
      c1->SaveAs(Form( "pred_total_"+closureTests+"_%d_%dTo%d_%d.eps", iJetStart-1, iJetStart+iJet_n-2, jJetStart-1, jJetStart+jJet_n-2 ) );
    } else {
      c1->SaveAs("pred_total_"+closureTests+".eps");
    }
    c1->Update();
